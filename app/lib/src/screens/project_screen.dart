                ...
                Expanded(
                  child: plan == null
                      ...
                      : TabBarView(
                          ...
                          children: [
                            widget.isHost
                                ? DeckTab(bridge: widget.host!.bridge, title: widget.title ?? plan.manifest.projectName, worktree: widget.host!.worktreeName, canAddWorktree: !widget.host!.isWorktree, nowSlot: _nowStrip(plan, graph), testPush: widget.host!.testPush, onChromeHidden: _onChromeHidden, files: widget.host!.files, loadFile: widget.host!.readFile, onWriteFile: widget.host!.writeRules, git: widget.host!.gitStatus, onGit: widget.host!.gitOp, autopilot: widget.host!.autopilot.state, onAutopilot: widget.host!.setAutopilot, run: widget.host!.run.state, onRun: widget.host!.runAction, runLog: (_) => widget.host!.run.logStream, mirrorHooks: widget.host!.mirrorHooks, builds: widget.host!.builds.builds, buildOnFlip: widget.host!.builds.buildOnFlip, onBuild: widget.host!.buildAction, onSwitchSession: widget.host!.switchSession, onDeleteSession: widget.host!.deleteSession)
