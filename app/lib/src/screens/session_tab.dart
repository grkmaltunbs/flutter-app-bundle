      ...
      builder: (context, _) {
        ...
        return ListView(
          ...
          children: [
            ...
            if (h.shotError != null) Padding(padding: const EdgeInsets.only(top: 6), child: Text('The last Done push went without its frame: ${h.shotError}', style: TextStyle(fontSize: 12.5, color: t.warn))),
