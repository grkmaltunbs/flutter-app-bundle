        ...
        child: ConstrainedBox(
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                Text('K.A.T.Y.A', textAlign: TextAlign.center, style: t.display(32, ls: 6)),
                const SizedBox(height: 6),
                Text('KODU ANLAYAN TECRÜBELİ YAPAY AKIL', textAlign: TextAlign.center, style: t.readout(10)),
                const SizedBox(height: 4),
                Text('Your plan, your Claude Code, your phone.', textAlign: TextAlign.center, style: TextStyle(fontSize: 13, color: t.muted)),
