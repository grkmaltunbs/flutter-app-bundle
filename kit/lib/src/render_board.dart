...
String renderBoardHtml(Plan plan, {required String today}) {
  ...
  b.writeln('<footer class="foot">Generated by <code>kit render board</code> from <code>plan/</code>. Comments on this page reach Claude; a bubble or a card is the address.</footer>');
  b.writeln('</main>');
  b.writeln(_script);
  return b.toString();
}
