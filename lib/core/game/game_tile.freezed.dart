...
$GameTileCopyWith<GameTile> get copyWith => _$GameTileCopyWithImpl<GameTile>(this as GameTile, _$identity);
...
/// @nodoc
abstract mixin class $GameTileCopyWith<$Res>  {
...
/// @nodoc
class _$GameTileCopyWithImpl<$Res>
    implements $GameTileCopyWith<$Res> {
  _$GameTileCopyWithImpl(this._self, this._then);

  final GameTile _self;
  final $Res Function(GameTile) _then;
...
/// Adds pattern-matching-related methods to [GameTile].
extension GameTilePatterns on GameTile {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _GameTile value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _GameTile value)  $default,){
final _that = this;
switch (_that) {
case _GameTile():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _GameTile value)?  $default,){
final _that = this;
switch (_that) {
case _GameTile() when $default != null:
return $default(_that);case _:
...
@pragma('vm:prefer-inline')
_$GameTileCopyWith<_GameTile> get copyWith => __$GameTileCopyWithImpl<_GameTile>(this, _$identity);
...
/// @nodoc
abstract mixin class _$GameTileCopyWith<$Res> implements $GameTileCopyWith<$Res> {
...
/// @nodoc
class __$GameTileCopyWithImpl<$Res>
    implements _$GameTileCopyWith<$Res> {
  __$GameTileCopyWithImpl(this._self, this._then);

  final _GameTile _self;
  final $Res Function(_GameTile) _then;
